...
func (p *EditPage) StreamBody(qw422016 *qt422016.Writer) {
	//line template/namespace/edit.qtpl:24
	qw422016.N().S(` <div class="panel"> <form class="slim" method="POST" action="/u/`)
...
func (p *EditPage) StreamHeader(qw422016 *qt422016.Writer) {
	...
	//line template/namespace/edit.qtpl:77
	qw422016.E().S(p.Namespace.User.Username)
	//line template/namespace/edit.qtpl:77
	qw422016.N().S(`/`)
	//line template/namespace/edit.qtpl:77
	...
	//line template/namespace/edit.qtpl:77
	qw422016.N().S(`"> `)
	//line template/namespace/edit.qtpl:78
	qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
`)
	//line template/namespace/edit.qtpl:78
	qw422016.N().S(` </a> `)
	//line template/namespace/edit.qtpl:80
