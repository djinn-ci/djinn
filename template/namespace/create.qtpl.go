...
`)
	...
	//line template/namespace/create.qtpl:47
	qw422016.N().S(`</span> </div> <div class="input-field"> <label class="input-field-label">Description <small>(optional)</small></label> <input class="input-text" type="text" name="description"/> <span class="error">`)
	//line template/namespace/create.qtpl:52
	qw422016.E().S(p.Errors.First("description"))
	//line template/namespace/create.qtpl:52
	qw422016.N().S(`</span> </div> <div class="input-field"> <label class="input-option"> <input class="input-option-selector" type="radio" name="visibility" value="private" checked="true"/> <strong>Private</strong> `)
...
`)
	//line template/namespace/create.qtpl:58
	qw422016.N().S(` <div class="description">Only you will be able to view builds in the namespace.</div> </label> <label class="input-option"> <input class="input-option-selector" type="radio" name="visibility" value="internal"/> <strong>Internal</strong> `)
...
`)
	//line template/namespace/create.qtpl:64
	qw422016.N().S(` <div class="description">Anyone with an account will be able to view builds in the namespace.</div> </label> <label class="input-option"> <input class="input-option-selector" type="radio" name="visibility" value="public"/> <strong>Public</strong> `)
...
`)
	//line template/namespace/create.qtpl:70
	qw422016.N().S(` <div class="description">Anyone will be able to view builds in the namespace.</div> </label> </div> <div class="input-field"> <button type="submit" class="button button-primary">Create</button> </div> </form> </div> </div> `)
