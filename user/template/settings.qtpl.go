...
//line user/template/settings.qtpl:63
				qw422016.N().S(` `)
//line user/template/settings.qtpl:64
				p.streamrenderProvider(qw422016, prv)
//line user/template/settings.qtpl:64
				qw422016.N().S(` `)
...
//line user/template/settings.qtpl:75
...
//line user/template/settings.qtpl:92
		qw422016.N().S(p.CSRF)
//line user/template/settings.qtpl:92
...
//line user/template/settings.qtpl:96
...
//line user/template/settings.qtpl:101
		p.StreamError(qw422016, "new_password")
//line user/template/settings.qtpl:101
		qw422016.N().S(` </div> <div class="form-field"> <label class="label" for="verify_password">Verify Password</label> <input class="form-text" type="password" id="verify_password" name="verify_password" autocomplete="off"/> `)
//line user/template/settings.qtpl:106
...
//line user/template/settings.qtpl:114
	}
//line user/template/settings.qtpl:114
	qw422016.N().S(` `)
