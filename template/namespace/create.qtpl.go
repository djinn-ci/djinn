...
`)
		...
		//line template/namespace/create.qtpl:30
		qw422016.N().S(` <a href="/namespaces" class="dashboard-header-back">`)
...
`)
	...
	//line template/namespace/create.qtpl:33
	qw422016.N().S(` </h1> </div> <div class="dashboard-body"> <div class="panel"> <form class="slim" method="POST" action="/namespaces"> `)
	...
	if p.Errors.First("namespace") != "" {
		...
		//line template/namespace/create.qtpl:43
		qw422016.N().S(`</div> `)
		//line template/namespace/create.qtpl:44
	}
	//line template/namespace/create.qtpl:44
	...
	//line template/namespace/create.qtpl:48
...
`)
	...
	//line template/namespace/create.qtpl:65
	qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
`)
	//line template/namespace/create.qtpl:71
	qw422016.N().S(` <div class="description">Anyone will be able to view builds in the namespace.</div> </label> </div> <div class="form-field"> <button type="submit" class="button button-primary">Create</button> </div> </form> </div> </div> `)
//line template/namespace/create.qtpl:81
}
