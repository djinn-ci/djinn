...
//line user/template/settings.qtpl:85
		qw422016.N().S(` <strong>Cleanup artifacts</strong> `)
...
`)
//line user/template/settings.qtpl:87
		qw422016.N().S(` <div class="form-desc">Clean up old artifacts that exceed 1GB in total</div> </label> </div> <div class="form-field"> <button type="submit" class="btn btn-primary">Update</button> </div> </form> <div class="separator"></div> <form method="POST" action="/settings/email"> <h2>Change email</h2> `)
...
//line user/template/settings.qtpl:190
	qw422016.N().S(` </li> `)
//line user/template/settings.qtpl:192
}
