...
func (p *Dashboard) StreamBody(qw422016 *qt422016.Writer) {
	//line template/dashboard.qtpl:39
	qw422016.N().S(` <div class="dashboard"> <div class="content"> <div class="header"> <div class="p-20 overflow"> <h1>`)
	...
	//line template/dashboard.qtpl:45
	qw422016.N().S(`</ul> </div> <div>`)
	//line template/dashboard.qtpl:47
	p.dashboardPage.StreamNavigation(qw422016)
	//line template/dashboard.qtpl:47
	qw422016.N().S(`</div> </div> <div class="p-20">`)
	//line template/dashboard.qtpl:49
	p.dashboardPage.StreamBody(qw422016)
	//line template/dashboard.qtpl:49
	qw422016.N().S(`</div> </div> <div class="sidebar"> <div class="sidebar-header"> <div class="logo"><div class="left"></div><div class="right"></div></div> <h2>Thrall</h2> </div> <ul class="nav"> <li class="nav-header">MANAGE</li> <li>`)
...
//line template/dashboard.qtpl:70
}
