...
//line user/template/login.qtpl:10
type Login struct {
	template.BasePage
	template.Form
...
//line user/template/login.qtpl:34
	qw422016.N().S(` <div class="auth-page"> <div class="auth-form"> <div class="auth-header"> <div class="logo"> <div class="handle"></div> <div class="lid"></div> <div class="lantern"></div> </div> <h1>Login to Djinn CI</h1> `)
...
//line user/template/login.qtpl:49
		qw422016.N().S(`"/> `)
//line user/template/login.qtpl:50
	}
//line user/template/login.qtpl:50
...
//line user/template/login.qtpl:71
			qw422016.N().S(` `)
//line user/template/login.qtpl:72
		}
//line user/template/login.qtpl:72
		qw422016.N().S(` <span>Login with `)
//line user/template/login.qtpl:73
...
//line user/template/login.qtpl:82
}
