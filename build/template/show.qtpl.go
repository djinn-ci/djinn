...
//line build/template/show.qtpl:51
...
//line build/template/show.qtpl:106
	}
//line build/template/show.qtpl:106
...
//line build/template/show.qtpl:114
		qw422016.N().S(` <span class="muted">--</span> `)
//line build/template/show.qtpl:116
	}
//line build/template/show.qtpl:116
...
//line build/template/show.qtpl:143
			qw422016.N().S(` </td> </tr> `)
//line build/template/show.qtpl:146
		}
//line build/template/show.qtpl:146
...
//line build/template/show.qtpl:161
...
//line build/template/show.qtpl:170
		qw422016.N().S(` </div> `)
//line build/template/show.qtpl:172
	}
//line build/template/show.qtpl:172
...
//line build/template/show.qtpl:184
		qw422016.N().S(` `)
//line build/template/show.qtpl:185
	}
//line build/template/show.qtpl:185
	qw422016.N().S(` `)
...
//line build/template/show.qtpl:189
		qw422016.N().S(` <li> `)
//line build/template/show.qtpl:191
		if p.Build.Pinned {
//line build/template/show.qtpl:191
...
//line build/template/show.qtpl:200
		} else {
//line build/template/show.qtpl:200
...
//line build/template/show.qtpl:324
	}
//line build/template/show.qtpl:324
	qw422016.N().S(` </div> </div> </div> `)
//line build/template/show.qtpl:328
}
...
//line build/template/show.qtpl:330
...
//line build/template/show.qtpl:332
		qw422016.N().S(` <a href="`)
//line build/template/show.qtpl:333
		qw422016.E().S(p.Build.Namespace.Endpoint())
//line build/template/show.qtpl:333
		qw422016.N().S(`">`)
//line build/template/show.qtpl:333
		qw422016.E().V(p.Build.Namespace.Name)
//line build/template/show.qtpl:333
		qw422016.N().S(`</a> / `)
//line build/template/show.qtpl:334
	}
//line build/template/show.qtpl:334
	qw422016.N().S(` Build #`)
//line build/template/show.qtpl:335
	qw422016.E().V(p.Build.Number)
//line build/template/show.qtpl:335
	qw422016.N().S(` / `)
//line build/template/show.qtpl:335
...
//line build/template/show.qtpl:337
		qw422016.N().S(` `)
//line build/template/show.qtpl:338
	}
//line build/template/show.qtpl:338
	qw422016.N().S(` `)
//line build/template/show.qtpl:339
}
