...
//line user/template/login.qtpl:33
	qw422016.N().S(` <div class="auth-page"> <div class="auth-form"> <div class="auth-header"> <div class="brand"> <div class="left"></div> <div class="right"></div> </div> <h1>Login to Djinn CI</h1> `)
...
//line user/template/login.qtpl:45
	qw422016.N().S(` `)
//line user/template/login.qtpl:46
	if p.RedirectURI != "" {
//line user/template/login.qtpl:46
...
//line user/template/login.qtpl:51
	qw422016.E().S(p.Fields["handle"])
//line user/template/login.qtpl:51
	qw422016.N().S(`" autocomplete="off"/> `)
//line user/template/login.qtpl:52
...
//line user/template/login.qtpl:57
...
//line user/template/login.qtpl:68
			qw422016.N().S(` `)
//line user/template/login.qtpl:69
			qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
//line user/template/login.qtpl:74
	}
//line user/template/login.qtpl:74
...
//line user/template/login.qtpl:80
}
