...
`)
	//line template/namespace/create.qtpl:58
	qw422016.N().S(` <div class="form-desc">Anyone will be able to view builds in the namespace.</div> </label> </div> <div class="form-field"> <button type="submit" class="btn btn-primary">Create</button> </div> </form> `)
