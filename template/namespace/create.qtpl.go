...
func (p *CreatePage) StreamBody(qw422016 *qt422016.Writer) {
	...
	//line template/namespace/create.qtpl:25
	...
	//line template/namespace/create.qtpl:35
	qw422016.N().S(` </div> <div class="form-field"> <label class="label" for="description">Description <small>(optional)</small></label> <input class="form-text" type="text" name="description" value="`)
	...
	//line template/namespace/create.qtpl:40
	qw422016.N().S(` </div> <div class="form-field"> <label class="form-option"> <input class="form-selector" type="radio" name="visibility" value="private" checked="trust"/> <strong>Private</strong> `)
...
//line template/namespace/create.qtpl:67
}
