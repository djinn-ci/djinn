...
func (p *CreatePage) StreamBody(qw422016 *qt422016.Writer) {
	//line template/namespace/create.qtpl:24
	qw422016.N().S(` <div class="dashboard-header"> <h1><a href="/namespaces">`)
...
`)
	//line template/namespace/create.qtpl:26
	qw422016.N().S(`</a> Create Namespace</h1> </div> <div class="dashboard-body"> <div class="panel panel-slim"> <form method="POST" action="/namespaces"> `)
