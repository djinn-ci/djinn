...
func (p *ShowCollaborators) StreamBody(qw422016 *qt422016.Writer) {
	...
	if len(p.Collaborators) == 0 {
		...
		for _, c := range p.Collaborators {
			//line template/namespace/show.qtpl:123
			qw422016.N().S(` <tr> <td>`)
			//line template/namespace/show.qtpl:125
			...
			if p.User != nil && p.User.ID == p.Namespace.UserID {
				...
				//line template/namespace/show.qtpl:134
			}
			//line template/namespace/show.qtpl:134
			qw422016.N().S(` </tr> `)
		...
		//line template/namespace/show.qtpl:139
	}
	//line template/namespace/show.qtpl:139
	qw422016.N().S(` </div> `)
//line template/namespace/show.qtpl:141
}
...
func (p *ShowPage) StreamHeader(qw422016 *qt422016.Writer) {
	//line template/namespace/show.qtpl:143
	qw422016.N().S(` `)
	//line template/namespace/show.qtpl:144
...
`)
		//line template/namespace/show.qtpl:145
		qw422016.N().S(`</a> `)
		//line template/namespace/show.qtpl:146
	} else {
		//line template/namespace/show.qtpl:146
...
//line template/namespace/show.qtpl:156
...
//line template/namespace/show.qtpl:165
func (p *ShowPage) StreamNavigation(qw422016 *qt422016.Writer) {
	//line template/namespace/show.qtpl:165
	qw422016.N().S(` <li> <a href="`)
	//line template/namespace/show.qtpl:167
	qw422016.E().S(p.Namespace.UIEndpoint())
	//line template/namespace/show.qtpl:167
	qw422016.N().S(`" class="`)
	//line template/namespace/show.qtpl:167
...
`)
	...
	//line template/namespace/show.qtpl:172
...
`)
	...
	//line template/namespace/show.qtpl:177
...
`)
	...
	//line template/namespace/show.qtpl:182
...
`)
	...
	//line template/namespace/show.qtpl:187
...
`)
	...
	//line template/namespace/show.qtpl:192
	qw422016.E().S(p.Namespace.UIEndpoint("-", "collaborators"))
	//line template/namespace/show.qtpl:192
	qw422016.N().S(`" class="`)
	//line template/namespace/show.qtpl:192
...
//line template/namespace/show.qtpl:196
}
