...
//line template/namespace/table.qtpl:6
import (
	qtio422016 "io"
...
func StreamRenderTable(qw422016 *qt422016.Writer, namespaces []*model.Namespace) {
	//line template/namespace/table.qtpl:6
	qw422016.N().S(` <table class="table"> <thead> <tr> <th>NAME</th> <th>LAST BUILD</th> <th></th> </tr> </thead> <tbody> `)
	//line template/namespace/table.qtpl:16
	for _, n := range namespaces {
		...
		switch n.Visibility {
		//line template/namespace/table.qtpl:31
		case model.Private:
			//line template/namespace/table.qtpl:31
			qw422016.N().S(` `)
