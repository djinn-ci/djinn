...
func (p *CreatePage) StreamBody(qw422016 *qt422016.Writer) {
	//line template/namespace/create.qtpl:24
	qw422016.N().S(` <form class="slim" method="POST" action="/namespaces"> `)
	//line template/namespace/create.qtpl:26
	...
	//line template/namespace/create.qtpl:40
	qw422016.N().S(`</div> </div> <div class="form-field"> <label class="option"> <input class="selector" type="radio" name="visibility" value="private" checked="trust"/> <strong>Private</strong> `)
...
`)
	//line template/namespace/create.qtpl:46
	qw422016.N().S(` <div class="description">You choose who can view builds in the namespace.</div> </label> <label class="option"> <input class="selector" type="radio" name="visibility" value="internal"/> <strong>Internal</strong> `)
...
`)
	//line template/namespace/create.qtpl:52
	qw422016.N().S(` <div class="description">Anyone with an account will be able to view builds in the namespace.</div> </label> <label class="option"> <input class="selector" type="radio" name="visibility" value="public"/> <strong>Public</strong> `)
...
`)
	//line template/namespace/create.qtpl:58
	qw422016.N().S(` <div class="description">Anyone will be able to view builds in the namespace.</div> </label> </div> <div class="form-field"> <button type="submit" class="button button-primary">Create</button> </div> </form> `)
//line template/namespace/create.qtpl:66
}
...
func (p *CreatePage) StreamHeader(qw422016 *qt422016.Writer) {
	//line template/namespace/create.qtpl:68
	qw422016.N().S(` `)
	//line template/namespace/create.qtpl:69
	if p.Parent != nil && !p.Parent.IsZero() {
		//line template/namespace/create.qtpl:69
...
//line template/namespace/create.qtpl:78
