...
func StreamRenderIndex(qw422016 *qt422016.Writer, bb []*model.Build, uri, status, search string) {
	...
	if len(bb) == 0 && search == "" && status == "" {
		...
		//line template/build/render.qtpl:74
		qw422016.N().S(` `)
		//line template/build/render.qtpl:75
	}
	//line template/build/render.qtpl:75
	qw422016.N().S(` `)
...
func StreamRenderTable(qw422016 *qt422016.Writer, builds []*model.Build) {
	...
	for _, b := range builds {
		...
		//line template/build/render.qtpl:93
		...
		//line template/build/render.qtpl:95
		if b.Namespace != nil {
			//line template/build/render.qtpl:95
			qw422016.N().S(` <a href="`)
			//line template/build/render.qtpl:96
		...
		//line template/build/render.qtpl:102
		for _, t := range b.Tags {
			//line template/build/render.qtpl:102
			qw422016.N().S(` <a class="pill pill-light" href="?tag=`)
			//line template/build/render.qtpl:103
			qw422016.E().S(t.Name)
			//line template/build/render.qtpl:103
			qw422016.N().S(`">`)
			//line template/build/render.qtpl:103
		...
		if !b.FinishedAt.Valid || !b.StartedAt.Valid {
			...
			//line template/build/render.qtpl:109
			qw422016.N().S(` `)
			//line template/build/render.qtpl:110
			qw422016.E().V(b.FinishedAt.Time.Sub(b.StartedAt.Time))
			//line template/build/render.qtpl:110
			qw422016.N().S(` `)
			//line template/build/render.qtpl:111
		}
		//line template/build/render.qtpl:111
		qw422016.N().S(` </td> </tr> `)
		//line template/build/render.qtpl:114
	}
	//line template/build/render.qtpl:114
	qw422016.N().S(` </tbody> </table> `)
//line template/build/render.qtpl:117
}
...
func StreamRenderObjectTable(qw422016 *qt422016.Writer, oo []*model.BuildObject) {
	...
	//line template/build/render.qtpl:132
	for _, o := range oo {
		//line template/build/render.qtpl:132
		qw422016.N().S(` <tr> <td> `)
		//line template/build/render.qtpl:135
		if o.Object != nil && !o.Object.DeletedAt.Valid {
			...
			//line template/build/render.qtpl:136
			qw422016.N().S(`</a> `)
			//line template/build/render.qtpl:137
		} else {
			//line template/build/render.qtpl:137
			qw422016.N().S(` <a title="Object not found"><strike>`)
			//line template/build/render.qtpl:138
			qw422016.E().S(o.Source)
			//line template/build/render.qtpl:138
			qw422016.N().S(`</strike></a> `)
			//line template/build/render.qtpl:139
		}
		//line template/build/render.qtpl:139
		qw422016.N().S(` </td> <td><span class="code">`)
		//line template/build/render.qtpl:141
		qw422016.E().S(o.Name)
		//line template/build/render.qtpl:141
		qw422016.N().S(`</span></td> <td> `)
		//line template/build/render.qtpl:143
		if o.Object != nil {
			//line template/build/render.qtpl:143
			qw422016.N().S(` <span class="code">`)
			//line template/build/render.qtpl:144
			qw422016.E().S(o.Object.Type)
			//line template/build/render.qtpl:144
			qw422016.N().S(`</span> `)
			//line template/build/render.qtpl:145
		} else {
			//line template/build/render.qtpl:145
			qw422016.N().S(` <span class="code">--</span> `)
			//line template/build/render.qtpl:147
		}
		//line template/build/render.qtpl:147
		qw422016.N().S(` </td> <td> `)
		...
		if o.Object != nil {
			//line template/build/render.qtpl:150
			qw422016.N().S(` <span class="code">`)
			//line template/build/render.qtpl:151
			...
			//line template/build/render.qtpl:152
			qw422016.N().S(` <span class="code">--</span> `)
			//line template/build/render.qtpl:154
		}
		//line template/build/render.qtpl:154
		qw422016.N().S(` </td> <td> `)
		...
		if o.Object != nil {
			//line template/build/render.qtpl:157
			qw422016.N().S(` <span class="code">`)
			//line template/build/render.qtpl:158
			qw422016.E().S(fmt.Sprintf("%x", o.Object.SHA256))
			//line template/build/render.qtpl:158
			qw422016.N().S(`</span> `)
			//line template/build/render.qtpl:159
		} else {
			//line template/build/render.qtpl:159
			qw422016.N().S(` <span class="code">--</span> `)
			//line template/build/render.qtpl:161
		}
		//line template/build/render.qtpl:161
		qw422016.N().S(` </td> <td class="align-right"> `)
		//line template/build/render.qtpl:164
		if o.Placed {
			//line template/build/render.qtpl:164
			qw422016.N().S(` <span class="pill pill-green">`)
			//line template/build/render.qtpl:165
			qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
<path d="M9 16.172l10.594-10.594 1.406 1.406-12 12-5.578-5.578 1.406-1.406z"></path>
</svg>
`)
			...
			//line template/build/render.qtpl:167
			qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
<path d="M18.984 6.422l-5.578 5.578 5.578 5.578-1.406 1.406-5.578-5.578-5.578 5.578-1.406-1.406 5.578-5.578-5.578-5.578 1.406-1.406 5.578 5.578 5.578-5.578z"></path>
</svg>
...
//line template/build/render.qtpl:176
func StreamRenderTagTable(qw422016 *qt422016.Writer, tt []*model.Tag, csrf string) {
	...
	//line template/build/render.qtpl:186
	for _, t := range tt {
		//line template/build/render.qtpl:186
		qw422016.N().S(` <tr> <td><a href="/?tag=`)
		//line template/build/render.qtpl:188
		qw422016.E().S(t.Name)
		//line template/build/render.qtpl:188
		...
		//line template/build/render.qtpl:188
		qw422016.N().S(`</a></td> <td>`)
		//line template/build/render.qtpl:189
		...
		//line template/build/render.qtpl:191
		qw422016.E().S(t.UIEndpoint())
		//line template/build/render.qtpl:191
		qw422016.N().S(`"> `)
		//line template/build/render.qtpl:192
		qw422016.N().S(csrf)
		//line template/build/render.qtpl:192
		...
		//line template/build/render.qtpl:198
	}
	//line template/build/render.qtpl:198
	qw422016.N().S(` </tbody> </table> `)
//line template/build/render.qtpl:201
}
...
//line template/build/render.qtpl:203
func StreamRenderVariableTable(qw422016 *qt422016.Writer, vv []*model.BuildVariable) {
	...
	//line template/build/render.qtpl:213
	for _, v := range vv {
		//line template/build/render.qtpl:213
		qw422016.N().S(` <tr> <td><span class="code">`)
		//line template/build/render.qtpl:215
		qw422016.E().S(v.Key)
		//line template/build/render.qtpl:215
		qw422016.N().S(`</span></td> <td><span class="code">`)
		//line template/build/render.qtpl:216
		qw422016.E().S(v.Value)
		//line template/build/render.qtpl:216
		qw422016.N().S(`</span></td> <td>`)
		//line template/build/render.qtpl:217
		...
		//line template/build/render.qtpl:217
		qw422016.N().S(`</td> </tr> `)
		//line template/build/render.qtpl:219
	}
	//line template/build/render.qtpl:219
	qw422016.N().S(` </tbody> </table> `)
//line template/build/render.qtpl:222
}
