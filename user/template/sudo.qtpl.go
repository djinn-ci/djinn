...
//line user/template/sudo.qtpl:2
package template
...
//line user/template/sudo.qtpl:9
import (
	qtio422016 "io"
...
//line user/template/sudo.qtpl:10
type Sudo struct {
	template.BasePage
	template.Form
...
//line user/template/sudo.qtpl:23
func (p *Sudo) StreamTitle(qw422016 *qt422016.Writer) {
//line user/template/sudo.qtpl:23
	qw422016.N().S(` Authorize action - Djinn CI `)
//line user/template/sudo.qtpl:25
}

//line user/template/sudo.qtpl:25
func (p *Sudo) WriteTitle(qq422016 qtio422016.Writer) {
//line user/template/sudo.qtpl:25
...
//line user/template/sudo.qtpl:27
func (p *Sudo) StreamFooter(qw422016 *qt422016.Writer) {
//line user/template/sudo.qtpl:27
	qw422016.N().S(` <style type="text/css">`)
//line user/template/sudo.qtpl:28
...
//line user/template/sudo.qtpl:28
	qw422016.N().S(`</style> `)
//line user/template/sudo.qtpl:29
}

//line user/template/sudo.qtpl:29
func (p *Sudo) WriteFooter(qq422016 qtio422016.Writer) {
//line user/template/sudo.qtpl:29
	qw422016 := qt422016.AcquireWriter(qq422016)
//line user/template/sudo.qtpl:29
...
//line user/template/sudo.qtpl:31
func (p *Sudo) StreamBody(qw422016 *qt422016.Writer) {
//line user/template/sudo.qtpl:31
	qw422016.N().S(` <div class="auth-page"> <div class="auth-form"> <div class="auth-header"> <div class="logo"> <div class="handle"></div> <div class="lid"></div> <div class="lantern"></div> </div> <h1>Authorize action</h1> `)
//line user/template/sudo.qtpl:41
	alert.StreamRender(qw422016, p.Alert, "")
//line user/template/sudo.qtpl:41
	qw422016.N().S(` </div> <form method="POST" action="/sudo"> `)
//line user/template/sudo.qtpl:44
	qw422016.N().V(p.CSRF)
//line user/template/sudo.qtpl:44
	qw422016.N().S(` <input type="hidden" name="sudo_url" value="`)
//line user/template/sudo.qtpl:45
	qw422016.E().S(p.SudoURL)
//line user/template/sudo.qtpl:45
	qw422016.N().S(`"/> <input type="hidden" name="sudo_referer" value="`)
//line user/template/sudo.qtpl:46
	qw422016.E().S(p.SudoReferer)
//line user/template/sudo.qtpl:46
	qw422016.N().S(`"/> <input type="hidden" name="sudo_token" value="`)
//line user/template/sudo.qtpl:47
...
//line user/template/sudo.qtpl:51
	p.StreamError(qw422016, "password")
//line user/template/sudo.qtpl:51
	qw422016.N().S(` </div> <div class="input-field"> <button type="submit" class="btn btn-primary">Authorize</button> </div> </form> </div> </div> `)
//line user/template/sudo.qtpl:59
}

//line user/template/sudo.qtpl:59
func (p *Sudo) WriteBody(qq422016 qtio422016.Writer) {
//line user/template/sudo.qtpl:59
	qw422016 := qt422016.AcquireWriter(qq422016)
//line user/template/sudo.qtpl:59
