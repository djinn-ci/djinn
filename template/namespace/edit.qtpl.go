...
`)
	...
	//line template/namespace/edit.qtpl:28
	qw422016.N().S(` - Edit</h1> </div> <div class="body"> <div class="panel"> <form class="slim" method="POST" action="/u/`)
...
`)
	...
	//line template/namespace/edit.qtpl:69
	...
	//line template/namespace/edit.qtpl:71
	qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
//line template/namespace/edit.qtpl:81
}
