...
//line template/login.qtpl:36
func (p *Login) streamauthForm(qw422016 *qt422016.Writer, auth AuthForm) {
//line template/login.qtpl:36
	qw422016.N().S(` <form method="POST" action="/login"> `)
//line template/login.qtpl:38
	qw422016.N().V(auth.CSRF)
//line template/login.qtpl:38
	qw422016.N().S(` <input type="hidden" name="auth_mech" value="`)
//line template/login.qtpl:39
	qw422016.E().S(auth.Mech)
//line template/login.qtpl:39
	qw422016.N().S(`"/> `)
//line template/login.qtpl:40
	if p.RedirectURI != "" {
//line template/login.qtpl:40
		qw422016.N().S(` <input type="hidden" name="redirect_uri" value="`)
//line template/login.qtpl:41
		qw422016.E().S(p.RedirectURI)
//line template/login.qtpl:41
		qw422016.N().S(`"/> `)
//line template/login.qtpl:42
	}
//line template/login.qtpl:42
	qw422016.N().S(` `)
//line template/login.qtpl:43
	if auth.Mech == user.InternalProvider {
//line template/login.qtpl:43
		qw422016.N().S(` `)
//line template/login.qtpl:44
		auth.StreamField(qw422016, form.Field{
			ID:   "handle",
			Name: "Email / Username",
			Type: form.Text,
		})
//line template/login.qtpl:48
		qw422016.N().S(` `)
//line template/login.qtpl:49
		auth.StreamField(qw422016, form.Field{
			ID:   "password",
			Name: "Password",
			Type: form.Password,
		})
//line template/login.qtpl:53
		qw422016.N().S(` `)
//line template/login.qtpl:54
	}
//line template/login.qtpl:54
	qw422016.N().S(` `)
//line template/login.qtpl:55
	switch auth.Provider {
//line template/login.qtpl:56
	case "github":
//line template/login.qtpl:56
		qw422016.N().S(` <div class="form-field"> <button type="submit" class="btn provider-btn provider-`)
//line template/login.qtpl:58
		qw422016.E().S(auth.Provider)
//line template/login.qtpl:58
		qw422016.N().S(`"> `)
//line template/login.qtpl:59
...
//line template/login.qtpl:59
		qw422016.E().S(providerNames[auth.Provider])
//line template/login.qtpl:59
		qw422016.N().S(`</span> </button> </div> `)
//line template/login.qtpl:62
	case "gitlab":
//line template/login.qtpl:62
		qw422016.N().S(` <div class="form-field"> <button type="submit" class="btn provider-btn provider-`)
//line template/login.qtpl:64
		qw422016.E().S(auth.Provider)
//line template/login.qtpl:64
		qw422016.N().S(`"> `)
//line template/login.qtpl:65
		qw422016.N().S(`<!-- Generated by IcoMoon.io -->
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
//line template/login.qtpl:65
		qw422016.N().S(`</span> </button> </div> `)
//line template/login.qtpl:68
	default:
//line template/login.qtpl:68
		qw422016.N().S(` <div class="form-field"> <button type="submit" class="btn btn-primary">Login</button> </div> `)
//line template/login.qtpl:72
	}
//line template/login.qtpl:72
	qw422016.N().S(` </form> `)
//line template/login.qtpl:74
}

//line template/login.qtpl:74
func (p *Login) writeauthForm(qq422016 qtio422016.Writer, auth AuthForm) {
//line template/login.qtpl:74
	qw422016 := qt422016.AcquireWriter(qq422016)
//line template/login.qtpl:74
	p.streamauthForm(qw422016, auth)
//line template/login.qtpl:74
	qt422016.ReleaseWriter(qw422016)
//line template/login.qtpl:74
}
...
//line template/login.qtpl:74
func (p *Login) authForm(auth AuthForm) string {
//line template/login.qtpl:74
	qb422016 := qt422016.AcquireByteBuffer()
//line template/login.qtpl:74
	p.writeauthForm(qb422016, auth)
//line template/login.qtpl:74
	qs422016 := string(qb422016.B)
//line template/login.qtpl:74
	qt422016.ReleaseByteBuffer(qb422016)
...
//line template/login.qtpl:80
	StreamLogo(qw422016)
//line template/login.qtpl:80
	qw422016.N().S(` <h1>Login to Djinn CI</h1> `)
//line template/login.qtpl:82
	StreamAlert(qw422016, p.Alert, "")
//line template/login.qtpl:82
	qw422016.N().S(` </div> `)
//line template/login.qtpl:84
	for _, auth := range p.Auths {
//line template/login.qtpl:84
		qw422016.N().S(` `)
//line template/login.qtpl:85
		p.streamauthForm(qw422016, auth)
//line template/login.qtpl:85
		qw422016.N().S(` `)
//line template/login.qtpl:86
	}
//line template/login.qtpl:86
	qw422016.N().S(` <div class="input-field">Don't have an account? <a href="/register">Register</a></div> <div class="input-field"><a href="/password_reset">Forgot your password?</a></div> </div> </div> `)
//line template/login.qtpl:91
}
