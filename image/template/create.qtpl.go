...
//line image/template/create.qtpl:2
package template
...
//line image/template/create.qtpl:7
import (
	qtio422016 "io"
...
//line image/template/create.qtpl:8
type Create struct {
	template.BasePage
	template.Form
...
//line image/template/create.qtpl:21
	qw422016.N().S(` <div class="panel"> <form class="panel-body slim" method="POST"> `)
//line image/template/create.qtpl:24
...
//line image/template/create.qtpl:27
...
//line image/template/create.qtpl:33
	p.FileForm.StreamSection(qw422016)
//line image/template/create.qtpl:33
	qw422016.N().S(` <dif class="form-field"> <button type="submit" class="btn btn-primary">Create</button> </div> </form> </div> `)
//line image/template/create.qtpl:39
}
...
//line image/template/create.qtpl:43
}
