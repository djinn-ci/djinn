...
func (p *ShowPage) StreamBody(qw422016 *qt422016.Writer) {
	//line template/object/show.qtpl:27
	qw422016.N().S(` <div class="panel"> <table class="table"> `)
	//line template/object/show.qtpl:30
	if p.Object.Namespace != nil {
		//line template/object/show.qtpl:30
		qw422016.N().S(` <tr> <td>Namespace</td> <td class="align-right"><a href="`)
		//line template/object/show.qtpl:33
		qw422016.E().S(p.Object.Namespace.UIEndpoint())
		//line template/object/show.qtpl:33
		qw422016.N().S(`">`)
		//line template/object/show.qtpl:33
		qw422016.E().S(p.Object.Namespace.Path)
		//line template/object/show.qtpl:33
		qw422016.N().S(`</a></td> </tr> `)
		//line template/object/show.qtpl:35
	}
	//line template/object/show.qtpl:35
	qw422016.N().S(` <tr> <td>Name</td> <td class="align-right">`)
