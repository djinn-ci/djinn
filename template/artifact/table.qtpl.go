...
func StreamRenderIndex(qw422016 *qt422016.Writer, aa []*model.Artifact, uri, search string) {
	//line template/artifact/table.qtpl:11
	qw422016.N().S(` `)
	//line template/artifact/table.qtpl:12
	if len(oo) == 0 && search == "" {
		//line template/artifact/table.qtpl:12
		qw422016.N().S(` <div class="panel-message muted">No artifacts have been collected from this build.</div> `)
		//line template/artifact/table.qtpl:14
	} else {
		//line template/artifact/table.qtpl:14
		qw422016.N().S(` <div class="panel-header">`)
		//line template/artifact/table.qtpl:15
		template.StreamRenderSearch(qw422016, uri, search, "Find an artifact...")
		//line template/artifact/table.qtpl:15
		qw422016.N().S(`</div> `)
		//line template/artifact/table.qtpl:16
		if len(aa) == 0 && search != "" {
			//line template/artifact/table.qtpl:16
			qw422016.N().S(` <div class="panel-message muted">No results found.</div> `)
			//line template/artifact/table.qtpl:18
		} else {
			//line template/artifact/table.qtpl:18
			qw422016.N().S(` `)
			//line template/artifact/table.qtpl:19
			StreamRenderTable(qw422016, aa)
			//line template/artifact/table.qtpl:19
			qw422016.N().S(` `)
			//line template/artifact/table.qtpl:20
		}
		//line template/artifact/table.qtpl:20
		qw422016.N().S(` `)
		//line template/artifact/table.qtpl:21
	}
	//line template/artifact/table.qtpl:21
	qw422016.N().S(` `)
...
func StreamRenderTable(qw422016 *qt422016.Writer, aa []*model.Artifact) {
	...
	//line template/artifact/table.qtpl:36
	for _, a := range aa {
		//line template/artifact/table.qtpl:36
		...
		if len(a.MD5) == 0 {
			//line template/artifact/table.qtpl:43
			qw422016.N().S(` -- `)
			//line template/artifact/table.qtpl:45
		} else {
			//line template/artifact/table.qtpl:45
			qw422016.N().S(` `)
		...
		//line template/artifact/table.qtpl:52
		if len(a.SHA256) == 0 {
			//line template/artifact/table.qtpl:52
			qw422016.N().S(` -- `)
			//line template/artifact/table.qtpl:54
		} else {
			//line template/artifact/table.qtpl:54
			qw422016.N().S(` `)
			//line template/artifact/table.qtpl:55
			qw422016.E().S(fmt.Sprintf("%x", a.SHA256))
			//line template/artifact/table.qtpl:55
			qw422016.N().S(` `)
			//line template/artifact/table.qtpl:56
		}
		//line template/artifact/table.qtpl:56
		qw422016.N().S(` </span> </td> </tr> `)
		//line template/artifact/table.qtpl:60
	}
	//line template/artifact/table.qtpl:60
	qw422016.N().S(` </tbody> </table> `)
//line template/artifact/table.qtpl:63
}
