...
//line key/template/index.qtpl:9
import (
	qtio422016 "io"
...
//line key/template/index.qtpl:10
type Index struct {
	template.BasePage
...
//line key/template/index.qtpl:21
...
//line key/template/index.qtpl:30
...
//line key/template/index.qtpl:44
...
//line key/template/index.qtpl:48
					qw422016.N().S(` <a href="`)
//line key/template/index.qtpl:49
...
//line key/template/index.qtpl:55
				if p.User.ID != k.UserID {
//line key/template/index.qtpl:55
					qw422016.N().S(` <span class="muted">`)
//line key/template/index.qtpl:56
...
//line key/template/index.qtpl:66
				}
//line key/template/index.qtpl:66
				qw422016.N().S(` </td> </tr> `)
//line key/template/index.qtpl:69
			}
//line key/template/index.qtpl:69
			qw422016.N().S(` </tbody> </table> `)
//line key/template/index.qtpl:72
		}
//line key/template/index.qtpl:72
		qw422016.N().S(` `)
//line key/template/index.qtpl:73
	}
//line key/template/index.qtpl:73
	qw422016.N().S(` </div> `)
...
//line key/template/index.qtpl:75
	qw422016.N().S(` `)
//line key/template/index.qtpl:76
}
...
//line key/template/index.qtpl:78
	qw422016.N().S(` `)
//line key/template/index.qtpl:79
	p.StreamBody(qw422016)
//line key/template/index.qtpl:79
	qw422016.N().S(` `)
...
//line key/template/index.qtpl:86
	qw422016.N().S(` `)
//line key/template/index.qtpl:87
...
//line key/template/index.qtpl:89
	qw422016.N().S(` `)
//line key/template/index.qtpl:90
}
